...
<?php if( get_theme_mod('utsav_event_planner_slider_hide_show',false) != false){ ?>
	<section id="slider">
		    ...
		    <div class="carousel-inner" role="listbox">
		        ...
		        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		          	...
		          	<div class="carousel-caption">
						...
						<h1><?php the_title(); ?></h1>
						<p><?php $utsav_event_planner_excerpt = get_the_excerpt(); echo esc_html( utsav_event_planner_string_limit_words( $utsav_event_planner_excerpt, esc_attr(get_theme_mod('utsav_event_planner_slider_excerpt_length','2') ) )); ?></p>
			            </div>
			            <div class="read-btn">
		        		...
		        		<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>	
		          			<div class="col-lg-3 col-md-6">
		          				<div class="content-topic">
							      	...
							      	<h3><?php the_title(); ?></h3>
							      	<p><?php $utsav_event_planner_excerpt = get_the_excerpt(); echo esc_html( utsav_event_planner_string_limit_words( $utsav_event_planner_excerpt, esc_attr(get_theme_mod('utsav_event_planner_arrange_excerpt_length','20') ) )); ?></p>
							      	<div class="cat-btn">
